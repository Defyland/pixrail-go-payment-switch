...
| SPI pending work has a long-running process | `cmd/pixrail-worker/main.go`, `compose.yaml` | Done | Worker polls `SubmitPendingSPI` with configurable batch size and interval. |
